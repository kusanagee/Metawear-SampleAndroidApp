...
public class BarometerFragment extends SensorFragment {
    ...
    protected void boardReady() throws UnsupportedModuleException {
        barometer = mwBoard.getModule(BarometerBosch.class);
    }
    ...
    protected void setup() {
        ...
        barometer.pressure().addRoute(source -> source.stream((data, env) -> {
            ...
            return barometer.altitude().addRoute(source -> source.stream((data, env) -> {
                LineData chartData = chart.getData();
