...
public class ColorDetectorFragment extends SensorFragment {
    ...
    private ColorDetectorTcs34725 colorDetector;
    ...
    protected void boardReady() throws UnsupportedModuleException {
        colorDetector = mwBoard.getModule(ColorDetectorTcs34725.class);
    ...
    protected void setup() {
        ...
        colorDetector.configure()
                ...
                .commit();
        colorAdc.addRoute(source -> source.stream((data, env) -> {
            ...
            return timerModule.schedule(COLOR_SAMPLE_PERIOD, false, colorAdc::read);
        }).continueWith(task -> {
